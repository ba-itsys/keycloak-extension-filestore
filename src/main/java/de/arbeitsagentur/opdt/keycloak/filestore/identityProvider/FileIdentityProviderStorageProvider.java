...
public class FileIdentityProviderStorageProvider implements IdentityProviderStorageProvider {
    private final KeycloakSession session;

    public FileIdentityProviderStorageProvider(KeycloakSession session) {
    ...
    public void removeAll() {
        getRealm().getIdentityProvidersStream().forEach(idp -> getRealm()
                .removeIdentityProviderByAlias(idp.getAlias()));
    }
